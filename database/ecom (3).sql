...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 01:00 PM
...
INSERT INTO `cart` (`id`, `userid`, `usertype`, `qty`, `product_id`, `product_attr_id`, `added_on`) VALUES
(24, 21, 'Reg', 1, 2, 2, '2023-03-28 10:10:08'),
(27, 23, 'Reg', 1, 2, 2, '2023-03-28 10:45:39'),
(32, 25, 'Reg', 4, 1, 1, '2023-04-03 10:30:34'),
(33, 25, 'Reg', 1, 2, 2, '2023-04-03 10:38:01');
...
(19, 'Ravi Dhangar', 'progitha584@gmail.com', '8595527990', 'eyJpdiI6IlluclhLOHRRMlpiSCtQRkgwTVR1S1E9PSIsInZhbHVlIjoiSk9IM3grc0d0OWRtbEUxNDU2ekRKUT09IiwibWFjIjoiMzJjNzA0YjllM2NhNTk2MGMzZGQ1NzQzMzU2NzMyYWY3NzVlNDg3MDU5NmVhZWFlMDFkYWExNzEyNzIyYjg1ZSIsInRhZyI6IiJ9', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, '512851142', 0, '2023-03-28 04:27:03', '2023-03-28 04:27:03'),
(21, 'Ravi Dhangar', 'progitha584d@gmail.com', '8595527990', 'eyJpdiI6IjdWaWgvSzlIMTV0U0dTS3hhTU1Sdmc9PSIsInZhbHVlIjoiY2FPVjVIUGZHRFN5ankzZ3l3eWp3QT09IiwibWFjIjoiMjY4MjVmMGUzYTViM2UwYzNiYTRkM2FiY2FlNWZiODAzOGRmYTVjYzAxNzk4YTEwZmZmOGM3NjNhOTRjYjA1ZSIsInRhZyI6IiJ9', 'dasf', 'sadf', 'sadf', '512452', NULL, NULL, '1', 0, '272999908', 0, '2023-03-28 04:39:41', '2023-03-28 04:39:41'),
(25, 'anant', 'progitha58@gmail.com', '9137640812', 'eyJpdiI6IkVObEV6MjM4SCtnUjVDa1k4Y1BkZXc9PSIsInZhbHVlIjoiSitMNG5Qc2Q3amN0cVdmclgvb3kxZz09IiwibWFjIjoiZmE0ZGVmNDZiMTllN2U3YWM3Yzk3ZDE3YzRjNTUwODhjY2ZkZTMwNGQwOTJhNDNmNWY2NTBkNGU4NmZlNmVlMyIsInRhZyI6IiJ9', 'delhi', 'delhi', 'delhi', '88854', NULL, NULL, '1', 1, '', 0, '2023-03-28 05:19:31', '2023-03-28 05:19:31');
...
CREATE TABLE `orders` (
  ...
  `track_detail` varchar(255) DEFAULT NULL,
  `added_on` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`id`, `customers_id`, `name`, `email`, `mobile`, `address`, `city`, `state`, `pincode`, `coupon_code`, `coupon_value`, `order_status`, `payment_type`, `payment_status`, `payment_id`, `tnx_id`, `total_amount`, `track_detail`, `added_on`) VALUES
(1, 25, 'anant', 'progitha58@gmail.com', '9137640812', 'delhi', 'delhi', 'delhi', '88854', 'new200', 200, '2', 'Gateway', 'success', 'MOJO3401T05A52992211', 'b80c277aa4c246a199d4885d493238fd', 3197, 'reach noida', '2023-04-01 09:32:52');
...
(1, 1, 'dds', '70321442.png', 443, 5, 6, 2, 2),
...
(2, 25, 1, 'Worst', 'ddddd', 1, '2023-04-03 07:12:40'),
(3, 25, 1, 'Good', 'ddddd', 0, '2023-04-03 07:13:33'),
(4, 25, 1, 'Fantastic', 'i like this product', 0, '2023-04-03 09:01:14');
...
(4, 'XXL', 0, '2023-03-02 01:10:37', '2023-04-03 04:11:13');

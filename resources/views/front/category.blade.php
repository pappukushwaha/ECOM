            ...
            <aside class="aa-sidebar">
               ...
               <div class="aa-sidebar-widget">
                  ...
                  <ul class="aa-catg-nav">
                     ...
                     <li><a href="{{url('/category/'.$cat_left->category_slug)}}" class="cat_active_left">{{$cat_left->category_name}}</a></li>
                     @else
               ...
               <div class="aa-sidebar-widget">
                  ...
                  <div class="aa-color-tag">
                     ...
                     <a class="aa-color-{{strtolower($color->color)}} in_active" style="border: 2px solid #a600a9" href="javascript:void(0)"  onclick="setColor('{{$color->id}}', '1')"></a>    
                     @else
